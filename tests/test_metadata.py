...
def test_github_profile_draft_links_current_trial_and_contribution_paths():
    ...
    assert "https://github.com/aaronlab/browsertrace/issues/122" in profile_draft
...
def test_llms_txt_points_to_current_contribution_path():
    ...
    assert "Good first issue: https://github.com/aaronlab/browsertrace/issues/122" in llms
    assert (
...
def test_press_kit_includes_current_trial_and_contribution_paths():
    ...
    assert "Good first issue: https://github.com/aaronlab/browsertrace/issues/122" in press_kit
...
def test_product_hunt_packet_includes_current_trial_and_contribution_paths():
    ...
    assert "https://github.com/aaronlab/browsertrace/issues/122" in packet
