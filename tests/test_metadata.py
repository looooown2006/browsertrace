...
def test_github_profile_draft_links_current_trial_and_contribution_paths():
    ...
    assert "https://github.com/aaronlab/browsertrace/issues/165" in profile_draft
    assert "https://github.com/aaronlab/browsertrace/issues/164" not in profile_draft
...
def test_llms_txt_points_to_current_contribution_path():
    ...
    assert "Good first issue: https://github.com/aaronlab/browsertrace/issues/165" in llms
    assert "https://github.com/aaronlab/browsertrace/issues/164" not in llms
...
def test_press_kit_includes_current_trial_and_contribution_paths():
    ...
    assert "Good first issue: https://github.com/aaronlab/browsertrace/issues/165" in press_kit
    assert "https://github.com/aaronlab/browsertrace/issues/164" not in press_kit
...
def test_product_hunt_packet_includes_current_trial_and_contribution_paths():
    ...
    assert "https://github.com/aaronlab/browsertrace/issues/165" in packet
    assert "https://github.com/aaronlab/browsertrace/issues/164" not in packet
...
def test_show_hn_packet_links_current_good_first_issue():
    ...
    assert "current one is #165" in packet
    assert "#164" not in packet
...
def test_outreach_targets_link_first_pr_recipe_for_small_contributions():
    ...
    assert "https://github.com/aaronlab/browsertrace/issues/165" in contribution_reply
    assert "https://github.com/aaronlab/browsertrace/issues/164" not in contribution_reply
    assert "First PR Recipe" in contribution_reply
    assert "CONTRIBUTING.md#first-pr-recipe" in contribution_reply
    assert "first contribution small and reviewable" in contribution_reply
    assert "stars" not in contribution_reply.lower()
