...
def test_github_profile_draft_links_current_trial_and_contribution_paths():
    ...
    assert "https://github.com/aaronlab/browsertrace/issues/182" in profile_draft
    assert "https://github.com/aaronlab/browsertrace/issues/181" not in profile_draft
...
def test_readme_links_contributor_guide_near_contributing():
    ...
    assert "https://github.com/aaronlab/browsertrace/issues/182" in contributing_section
    assert "https://github.com/aaronlab/browsertrace/issues/181" not in contributing_section
...
def test_contributing_includes_first_pr_recipe():
    ...
    assert "https://github.com/aaronlab/browsertrace/issues/182" in recipe
    assert "https://github.com/aaronlab/browsertrace/issues/181" not in recipe
...
def test_llms_txt_points_to_current_contribution_path():
    ...
    assert "Good first issue: https://github.com/aaronlab/browsertrace/issues/182" in llms
    assert "https://github.com/aaronlab/browsertrace/issues/181" not in llms
...
def test_press_kit_includes_current_trial_and_contribution_paths():
    ...
    assert "Good first issue: https://github.com/aaronlab/browsertrace/issues/182" in press_kit
    assert "https://github.com/aaronlab/browsertrace/issues/181" not in press_kit
...
def test_response_templates_link_first_pr_recipe_for_small_contributions():
    ...
    assert "https://github.com/aaronlab/browsertrace/issues/182" in reply
    assert "https://github.com/aaronlab/browsertrace/issues/181" not in reply
...
```"""
    ...
    assert "https://github.com/aaronlab/browsertrace/issues/182" in reply_workflow
    assert "https://github.com/aaronlab/browsertrace/issues/181" not in reply_workflow
...
```"""
    ...
    assert "https://github.com/aaronlab/browsertrace/issues/182" in reply_shortcuts
    assert "https://github.com/aaronlab/browsertrace/issues/181" not in reply_shortcuts
...
```"""
    ...
    assert "https://github.com/aaronlab/browsertrace/issues/182" in triage
    assert "https://github.com/aaronlab/browsertrace/issues/181" not in triage
...
def test_directory_submission_sheet_links_first_pr_recipe_for_small_contributions():
    ...
    assert "https://github.com/aaronlab/browsertrace/issues/182" in contribution_reply
    assert "https://github.com/aaronlab/browsertrace/issues/181" not in contribution_reply
...
def test_product_hunt_packet_includes_current_trial_and_contribution_paths():
    ...
    assert "https://github.com/aaronlab/browsertrace/issues/182" in packet
    assert "https://github.com/aaronlab/browsertrace/issues/181" not in packet
...
def test_show_hn_packet_links_current_good_first_issue():
    ...
    assert "current one is #182" in packet
    assert "#181" not in packet
    assert "First PR Recipe" in contribution_reply
    assert "CONTRIBUTING.md#first-pr-recipe" in contribution_reply
    assert "first contribution small and reviewable" in contribution_reply
    assert "stars" not in contribution_reply.lower()
