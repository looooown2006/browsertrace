...
| GitHub awesome lists | Curated developer discovery lists | docs/launch/github-awesome-list-submissions.md | Yes | Repo, live demo, relevant guide | 9 awesome-list PRs open; monitor feedback; e2b CLA passed |
