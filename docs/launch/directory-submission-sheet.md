...
| GitHub awesome lists | Curated developer discovery lists | docs/launch/github-awesome-list-submissions.md | Yes | Repo, live demo, relevant guide | Tracked PRs are open; monitor feedback; e2b CLA passed |
