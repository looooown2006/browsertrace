...
| AgentKart | Open-source AI agent marketplace visitors | `https://www.agentkart.ai/submit` | Day 2 or 4 | Directory submission | Owner account likely required | Sign-in button present; static form has no usable submit handler |
...
| OSS AI Hub | Open-source AI tools and agents | `https://ossaihub.com/submit` | Day 4 | Directory submission | Submit from owner login | Fit is strong, but login required before submitting tools |
...
| BuilderAI Tools | Open-source AI developer tools | `https://builderai.tools/submit` | Day 4 | Directory submission | Submit from owner email | Use AI Observability & Evaluation; owner email and Cloudflare Turnstile required |
