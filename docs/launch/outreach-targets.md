...
| AgentKart | Open-source AI agent marketplace visitors | `https://www.agentkart.ai/submit` | Day 2 or 4 | Directory submission | Owner login likely required | Visible unauthenticated form has no action or method; try from the owner login once |
