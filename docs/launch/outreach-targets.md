...
| AgentKart | Open-source AI agent marketplace visitors | `https://www.agentkart.ai/submit` | Day 2 or 4 | Directory submission | Owner account likely required | Sign-in button is present; static form has no usable submit handler |
...
| OSS AI Hub | Open-source AI tools and agents | `https://ossaihub.com/submit` | Day 4 | Directory submission | Submit from owner login | Fit is strong, but login is required before submitting tools |
...
| AgentsTide | AI agents and browser-agent directory | `https://agentstide.com/` | Day 4 | Directory suggestion | Send from owner email | Browser Agents category is a clear fit; visible route exposes contact email only |
| BuilderAI Tools | Open-source AI developer tools | `https://builderai.tools/submit` | Day 4 | Directory submission | Submit from owner email | Use AI Observability & Evaluation; owner email and Cloudflare Turnstile are required |
| GitHub awesome lists | Developers browsing curated browser automation and AI-agent tool lists | `docs/launch/github-awesome-list-submissions.md` | Monitoring | Nine focused PRs are already open | Watch maintainer feedback | one blocked on owner CLA signature; Do not open more list PRs unless the target is clearly high-fit and non-duplicative |
...
5. Directory/newsletter submissions after `v0.1.15` links are stable. Use
...
The v0.1.15 release includes `browsertrace demo` for first-run onboarding,
