...
| CLIs.dev | Developers discovering CLI tools for AI agents and automation | `https://clis.dev/` | Day 4+ | CLI directory submission | Submit from owner browser/GitHub | Open directory for CLI discovery, automation, and agent workflows; include `uvx` install and JSON command examples |
