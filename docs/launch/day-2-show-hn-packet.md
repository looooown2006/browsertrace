...
```text
Yes. Good first issues are kept small and reviewable. The current one is #107,
which asks for a concise README no-signup local trial note near the release-tag install
