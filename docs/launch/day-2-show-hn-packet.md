...
```text
Yes. Good first issues are kept small and reviewable. The current one is #109,
which asks for a concise README demo-run-title note near the release-tag install
