...
```text
Yes. Good first issues are kept small and reviewable. The current one is #100,
which asks for a concise README release-notes note near the release-tag install
