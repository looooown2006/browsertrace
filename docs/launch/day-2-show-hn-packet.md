...
```text
Yes. Good first issues are kept small and reviewable. The current one is #86,
which asks for a concise README isolated trace storage note near the release-tag
