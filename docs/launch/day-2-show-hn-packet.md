...
```text
Yes. Good first issues are kept small and reviewable. The current one is #29,
which asks for a concise pytest fixture recipe for isolated trace storage. For
