...
```text
Yes. Good first issues are kept small and reviewable. The current one is #158,
which asks for a profile README link to the first-PR recipe in the contributor guide.
