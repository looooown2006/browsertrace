...
```text
Yes. Good first issues are kept small and reviewable. The current one is #48,
which asks for a concise README GitHub Actions artifact recipe link. For adapter
