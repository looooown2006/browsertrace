...
```text
Yes. Good first issues are kept small and reviewable. The current one is #106,
which asks for a concise README Windows trace-home note near the release-tag install
