...
```text
Yes. Good first issues are kept small and reviewable. The current one is #102,
which asks for a concise README Python-version note near the release-tag install
