...
```text
Yes. Good first issues are kept small and reviewable. The current one is #128,
which asks for a concise README automation recipe using the JSON CLI commands.
