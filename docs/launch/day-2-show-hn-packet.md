...
```text
Yes. Good first issues are kept small and reviewable. The current one is #156,
which asks for a README link to the first-PR recipe in the contributor guide.
