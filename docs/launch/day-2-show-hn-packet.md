...
```text
Yes. Good first issues are kept small and reviewable. The current one is #89,
which asks for grouping README install tips into a compact list. For adapter
work, the most useful first step is an integration request
