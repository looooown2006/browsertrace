...
```text
Yes. Good first issues are kept small and reviewable. The current one is #82,
which asks for a concise README list command note near the release-tag install
