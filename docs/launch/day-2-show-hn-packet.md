...
```text
Yes. Good first issues are kept small and reviewable. The current one is #119,
which asks for a concise README export success output note near the release-tag
