...
```text
Yes. Good first issues are kept small and reviewable. The current one is #61,
which asks for a concise README share-safe export example link. For adapter work,
