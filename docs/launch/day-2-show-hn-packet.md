...
```text
Yes. Good first issues are kept small and reviewable. The current one is #32,
which asks for a concise GitLab CI artifact recipe for public-safe exports. For
