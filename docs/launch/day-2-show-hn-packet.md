...
```text
Yes. Good first issues are kept small and reviewable. The current one is #157,
which asks for a press kit link to the first-PR recipe in the contributor guide.
