...
```text
Yes. Good first issues are kept small and reviewable. The current one is #95,
which asks for a concise README run-ID-prefix note near the release-tag install
