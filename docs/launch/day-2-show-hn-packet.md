...
```text
Yes. Good first issues are kept small and reviewable. The current one is #93,
which asks for a concise README example matrix note near the release-tag install
