...
```text
Yes. Good first issues are kept small and reviewable. The current one is #129,
which asks for a concise examples-page recipe using the JSON CLI commands. For
