...
```text
Yes. Good first issues are kept small and reviewable. The current one is #103,
which asks for a concise README no-network demo note near the release-tag install
