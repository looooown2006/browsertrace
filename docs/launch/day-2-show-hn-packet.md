...
```text
Yes. Good first issues are kept small and reviewable. The current one is #113,
which asks for a concise README self-contained export note near the release-tag
