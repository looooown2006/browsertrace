...
```text
Yes. Good first issues are kept small and reviewable. The current one is #118,
which asks for a concise README export output path note near the release-tag
