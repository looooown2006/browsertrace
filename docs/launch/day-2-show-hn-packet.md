...
```text
Yes. Good first issues are kept small and reviewable. The current one is #88,
which asks for a concise README export help note near the release-tag install
