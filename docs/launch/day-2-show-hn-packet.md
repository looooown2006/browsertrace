...
```text
Yes. Good first issues are kept small and reviewable. The current one is #101,
which asks for a concise README PyPI-tracking note near the release-tag install
