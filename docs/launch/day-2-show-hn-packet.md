...
```text
Yes. Good first issues are kept small and reviewable. The current one is #71,
which asks for a concise README launch discussion link near the failure
reporting section. For adapter work, the most useful first step is an
