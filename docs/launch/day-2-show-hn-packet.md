...
```text
Yes. Good first issues are kept small and reviewable. The current one is #99,
which asks for a concise README command-cheat-sheet note near the release-tag
