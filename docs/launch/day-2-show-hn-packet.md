...
```text
Yes. Good first issues are kept small and reviewable. The current one is #168,
which asks for an outreach targets link to the first-PR recipe in the contributor guide.
