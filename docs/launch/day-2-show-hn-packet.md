...
```text
Yes. Good first issues are kept small and reviewable. The current one is #78,
which asks for a concise README PyPI tracking issue link near the release-tag
