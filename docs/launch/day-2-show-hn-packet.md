...
```text
Yes. Good first issues are kept small and reviewable. The current one is #114,
which asks for a concise README localhost UI binding note near the release-tag
