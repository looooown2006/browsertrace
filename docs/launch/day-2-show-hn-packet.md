...
```text
Yes. Good first issues are kept small and reviewable. The current one is #110,
which asks for a concise README no-service examples note near the release-tag install
