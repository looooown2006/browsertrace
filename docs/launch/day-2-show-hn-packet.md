...
```text
Yes. Good first issues are kept small and reviewable. The current one is #163,
which asks for a targeted communities packet link to the first-PR recipe in the contributor guide.
