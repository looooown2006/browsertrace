...
```text
Yes. Good first issues are kept small and reviewable. The current one is #58,
which asks for a concise README port troubleshooting example link. For adapter work,
