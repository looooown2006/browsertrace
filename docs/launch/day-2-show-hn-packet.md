...
```text
Yes. Good first issues are kept small and reviewable. The current one is #112,
which asks for a concise README redact-export distinction note near the release-tag install
