...
```text
Yes. Good first issues are kept small and reviewable. The current one is #161,
which asks for an llms.txt link to the first-PR recipe in the contributor guide.
