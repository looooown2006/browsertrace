...
```text
Yes. Good first issues are kept small and reviewable. The current one is #162,
which asks for a Day 1 publish packet link to the first-PR recipe in the contributor guide.
