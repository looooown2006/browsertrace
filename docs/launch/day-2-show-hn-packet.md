...
```text
Yes. Good first issues are kept small and reviewable. The current one is #98,
which asks for a concise README static-demo note near the release-tag install
