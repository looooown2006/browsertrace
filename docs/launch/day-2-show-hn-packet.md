...
```text
Yes. Good first issues are kept small and reviewable. The current one is #105,
which asks for a concise README local UI URL note near the release-tag install
