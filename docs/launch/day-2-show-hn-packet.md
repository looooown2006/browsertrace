...
```text
Yes. Good first issues are kept small and reviewable. The current one is #94,
which asks for a concise README recent-runs note near the release-tag install
