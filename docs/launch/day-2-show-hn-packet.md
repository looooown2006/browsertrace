...
```text
Yes. Good first issues are kept small and reviewable. The current one is #117,
which asks for a concise README list output fields note near the release-tag
